...
namespace Exigo.Api
{
    ...
    public class EnterpriseApiSettings : IApiSettings
    {
        ...
        {
            this.LoginName  = "API_Username";
            this.Password   = "API_Password";
            this.CompanyKey = "exigodemo";
    ...
    public class EnterpriseSandboxApiSettings : IApiSettings
    {
        public EnterpriseSandboxApiSettings()
        {
            ...
            this.WebServiceUrl = "http://sandboxapi1.exigo.com/3.0/ExigoApi.asmx";
            this.ODataUrl = string.Format("http://sandboxapi1.exigo.com/4.0/{0}/model", this.CompanyKey);
            this.CustomerImagesUrl = string.Format("http://sandboxapi1.exigo.com/4.0/{0}/images", this.CompanyKey);
            this.ProductImagesUrl = string.Format("http://sandboxapi1.exigo.com/4.0/{0}/productimages", this.CompanyKey);
