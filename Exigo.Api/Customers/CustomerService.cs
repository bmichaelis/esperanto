...
namespace Exigo.Api
{
        ...
        public CustomerService(ICustomerService Provider = null)
        {
            ...
            else
            {
                ...
                if(defaultApiSettings.IsEnterprise)
                    this.Provider = new SqlCustomerProvider(defaultApiSettings);
                else
                    this.Provider = new ODataCustomerProvider(defaultApiSettings);
            }
        }
    ...
    public class WebServiceCustomerProvider : BaseWebServiceProvider, ICustomerService
    {
        ...
        public List<CustomerSubscription> GetCustomerSubscriptions(int CustomerID)
        {
            if(ApiSettings.IsEnterprise)
                return new SqlCustomerProvider(ApiSettings).GetCustomerSubscriptions(CustomerID);
            else
                return new ODataCustomerProvider(ApiSettings).GetCustomerSubscriptions(CustomerID);
        }
        ...
        {
            if(ApiSettings.IsEnterprise)
                return new SqlCustomerProvider(ApiSettings).GetCustomerType(CustomerTypeID);
            else
        ...
        {
            if(ApiSettings.IsEnterprise)
                return new SqlCustomerProvider(ApiSettings).GetCustomerStatus(CustomerStatusID);
            else
                return new ODataCustomerProvider(ApiSettings).GetCustomerStatus(CustomerStatusID);
        }
    }
    #endregion
    ...
    public class ODataCustomerProvider : BaseODataProvider, ICustomerService
    {
        ...
        {
            if(ApiSettings.IsEnterprise)
                return new SqlCustomerProvider(ApiSettings).GetCustomerSite(CustomerID);
            else
                return new WebServiceCustomerProvider(ApiSettings).GetCustomerSite(CustomerID);
        }
        public void CreateCustomerSite(CustomerSite CustomerSite)
        {
